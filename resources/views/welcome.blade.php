...
<body>
  ...
  <section id="services">
    <div class="services container">
      <div class="service-top">
        ...
        <p>The College provides an extensive portfolio of services in order to cater for the spiritual, emotional, moral, intellectual, social and physical needs of the students and to foster the development of all the dimensions of the whole person.</p>
      <p>
        The Mater Dei College Seal indicates the words: SAPIENTIA (wisdom, through scholarship), CARITAS (charity, through service), and ORATIO (prayer life, through living the Gospel). These are the values upheld by the college.</p>
        <p>As an extension of its advocacy of service through charity, Mater Dei College helps improve the livelihood of the community through programs such as organic farming seminars and goat-raising programs.
        </p></div>
  ...
  <section id="about">
    <div class="about container">
      <div class="col-left">
        <div class="about-img">
          <img src="../frontends/mdc/mdc.jpg" alt="img">
        </div>
      </div>
      <div class="col-right">
  ...
  <section id="contact">
    <div class="contact container">
      ...
      <div class="contact-item">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1311.418067018241!2d123.9753229034832!3d9.949437775006373!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33aa2587950df6f7%3A0xad4f0f3e2399e9d4!2sMater%20Dei%20College!5e0!3m2!1sen!2sph!4v1647920158196!5m2!1sen!2sph" loading="lazy"></iframe>
      </div>
    </div>
  </section>
  <!-- End Contact Section -->
...
.cta {
	...
	border: 2px solid rgb(247, 244, 245);
	font-size: 2rem;
	text-transform: uppercase;
...
#header .header {
	min-height: 8vh;
	background-color: rgba(116, 116, 122, 0);
...
/* Hero Section */
#hero {
	background-image: url(./frontends/mdc/mdc.jpg);
...
/* Footer */
#footer {
	background-image: linear-gradient(60deg, #1683ff 0%, #004b9b 100%);
}
#footer .footer {
	min-height: 50px;
	flex-direction: column;
...
@media only screen and (min-width: 768px) {
	...
	#about .about .col-left .about-img::after {
		...
		height: 98%;
		width: 98%;
		border: 10px solid rgb(72, 84, 255);
	}
	#about .col-right {
		text-align: left;
		padding: 30px;
