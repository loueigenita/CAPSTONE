@extends('layouts.admin', ['page' => 'New Provider', 'pageSlug' => 'provider', 'section' => 'providers'])
@section('content')
                        ...
                        <form method="post" action="{{ route('providers.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="phone" name="phone" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="Phone" value="{{ old('phone') }}" required>
