@extends('layouts.admin',['page' => 'Provider Information', 'pageSlug' => 'providers', 'section' => 'providers'])
                        ...
                        <tbody>
                            @foreach ($receipts as $receipt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('receipts.show', $receipt) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="bottom" title="Ver Receipt">
