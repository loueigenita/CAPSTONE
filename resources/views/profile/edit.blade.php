@extends('layouts.admin', ['page' => __('User Profile'), 'pageSlug' => 'profile', 'section' => 'users'])
...
@section('content')
    <div class="row">
        <div class="col-md-18">
                ...
                <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                    <div class="card-body">
                            ...
                            <div class="form-group{{ $errors->has('user_type') ? ' has-danger' : '' }}">
                                <label>Role</label>
                                <input type="text" name="user_type" class="form-control{{ $errors->has('user_type') ? ' is-invalid' : '' }}" placeholder="Role" value="{{ old('user_type', auth()->user()->user_type) }}">
            ...
            <div class="card ">
                <div class="card-header bg-dark">
                    <h5 class="title text-center">Password</h5>
                </div>
