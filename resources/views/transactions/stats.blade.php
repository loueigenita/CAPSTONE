@extends('layouts.admin', ['pageSlug' => 'tstats', 'page' => 'Statistics', 'section' => 'transactions'])
                            ...
                            <tbody>
                                @foreach($clients as $client)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('clients.transactions.add', $client) }}" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="Register Transation">
                            ...
                            <tbody>
                                @foreach($methods as $method)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('methods.show', $method) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="bottom" title="See Method">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
