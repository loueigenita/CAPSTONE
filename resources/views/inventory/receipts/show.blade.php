@extends('layouts.admin', ['page' => 'Manage Receipt', 'pageSlug' => 'receipts', 'section' => 'inventory'])
                        ...
                        <tbody>
                            @foreach ($receipt->products as $received_product)
                                <tr>
                                    ...
                                    <td>
                                        @if($receipt->finalized_at)
                                            <a href="{{ route('receipts.product.edit', ['receipt' => $receipt, 'receivedproduct' => $received_product]) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="bottom" title="Edit Pedido">
                                            ...
                                            <form action="{{ route('receipts.product.destroy', ['receipt' => $receipt, 'receivedproduct' => $received_product]) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
                                                <button type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete Product" onclick="confirm('Are You Sure You Want to Delete This Product.') ? this.parentElement.submit() : ''">
